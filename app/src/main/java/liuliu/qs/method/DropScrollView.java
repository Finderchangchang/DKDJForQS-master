...
public class DropScrollView extends ScrollView implements View.OnTouchListener {
    ...
    public DropScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
