...
public class UpdateManager {
    ...
    /* 下载包安装路径 */
    private static final String savePath = "/sdcard/DKDJForKP/";

    private static final String saveFileName = savePath + "DKDJForKP.apk";
    ...
    private void installApk() {
        downloadDialog.dismiss();//关闭当前进度条dialog
